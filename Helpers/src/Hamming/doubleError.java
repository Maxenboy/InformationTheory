...
public class doubleError {
	public static void main(String[] args) {
		...
		String[]list = new String[] { "0000","1000","0100","1010",
				"0110","1001","0101","1011","0111"};
		ArrayList<String> syndromes =new ArrayList<String>();
		syndromes.addAll(Arrays.asList(list));
		...
		for(String s:errors){
			...
			if(syndromes.contains(syndrome.toString())){
